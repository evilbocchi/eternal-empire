...
export = new Quest(script.Name)
    ...
    .addStage(new Stage()
        ...
        .setDialogue(new Dialogue(CaptainBacon, "Welcome aboard my glorious ship, stranger!")
            ...
            .monologue("Why don't you get my map for me first? It's at... uh... where is it, again?")
            .root
        )
        .onReached((stage) => {
    ...
    .addStage(new Stage()
        ...
        .onReached((stage) => {
            const triaActivation = new Dialogue(Tria, "Uh... so... I found this thing... I think it belongs to... um... someone important?")
                .monologue("I didn't mean to... I just... I was trying to put it somewhere safe... and now... it's gone.")
                .monologue("...I-I don't know what to do... I can't just leave it missing... someone's going to be mad at me...")
                .monologue("Maybe... maybe you can... I mean, if you want, you could... help me find it?")
                .monologue("Please... I don't want to get in trouble. I-I'm really bad at... adventure stuff...")
                .root;

            const redHerrings = [
                new Dialogue(OldNoob, "Captain Bacon's been complaining about having lost his map lately.")
                    .monologue("I haven't seen it around here, though.")
                    .root,
            ...
            for (const dialogue of redHerrings)
