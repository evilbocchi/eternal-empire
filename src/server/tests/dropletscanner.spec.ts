...
export = function () {
    ...
    describe("DropletScanner", () => {
        it("displays raw droplet worth without upgrades", () => {
            ...
            expect(output.find("RAW WORTH:")[0]).to.be.ok();
            expect(output.find("TOTAL:")[0]).to.be.ok();
            expect(output.find(firstDropletFunds.toString())[0]).to.be.ok();
        ...
        it("shows additive boost from upgrader", () => {
            ...
            expect(output.find("THEFIRSTUPGRADER:")[0]).to.be.ok();
            expect(output.find("+")[0]).to.be.ok();
        ...
        it("shows multiplicative boost from upgrader", () => {
            ...
            expect(output.find("SMALLREACTOR:")[0]).to.be.ok();
            expect(output.find("x")[0]).to.be.ok();
        ...
        it("does not show neutral boosts with +0 or x1", () => {
            ...
            expect(hasUpgraderLine).to.equal(false);
        ...
        it("shows health when droplet is damaged", () => {
            ...
            expect(output.find("HEALTH:")[0]).to.be.ok();
            expect(output.find("50")[0]).to.be.ok();
        ...
        it("does not show health when droplet is at full health", () => {
            ...
            expect(output.find("HEALTH:")[0]).to.equal(undefined);
