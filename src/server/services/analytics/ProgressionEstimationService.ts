...
export class ProgressionEstimationService implements OnStart {
    ...
    /**
     * Calculate the minimum time to obtain a specified revenue with the specified price.
     * 
    ...
    /**
     * Calculate the revenue by the specified items if optimally used.
     * 
     * @param items Items that are generating revenue and their amounts.
     * @param balance The balance to emulate for formula calculations.
     */
