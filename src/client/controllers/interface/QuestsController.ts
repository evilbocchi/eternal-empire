...
import { ADAPTIVE_TAB, CompletionFrame, LEVELS_WINDOW, LOCAL_PLAYER, LPUpgradeOption, QUESTS_WINDOW, SIDEBAR_BUTTONS, TRACKED_QUEST_WINDOW } from "client/constants";
