...
namespace NamedUpgrades {
    ...
    export const MoreFunds = new GainUpgrade()
        ...
        .setStepMul(10, (x) => new Price().setCost("Funds", __1_2.pow(x)))
        .setMul(x => new Price().setCost("Funds", __1_04.pow(x)));
    ...
    export const MorePower = new GainUpgrade()
        ...
        .setStepMul(10, (x) => new Price().setCost("Power", __1_2.pow(x)))
        .setMul(x => new Price().setCost("Power", __1_03.pow(x)));
    ...
    export const CryptographicFunds = new GainUpgrade()
        ...
        .setStepMul(10, (x) => new Price().setCost("Funds", __1_25.pow(x)))
        .setMul(x => new Price().setCost("Funds", __1_05.pow(x)));
    ...
    export const CryptographicPower = new GainUpgrade()
        ...
        .setStepMul(10, (x) => new Price().setCost("Power", __1_25.pow(x)))
        .setMul(x => new Price().setCost("Power", __1_04.pow(x)));
    ...
    export const SkilledMining = new GainUpgrade()
        ...
        .setStepMul(10, (x) => new Price().setCost("Bitcoin", __1_2.pow(x)))
        .setMul(x => new Price().setCost("Bitcoin", __1_1.pow(x)));
    ...
    export const LandReclaimationII = new GridSizeUpgrade("SlamoVillage")
        ...
        .setPriceFormula((amount) => new Price().setCost("Skill", OnoeNum.fromSerika(5, (amount * 3) - 3)))
        .setFormula((y, x) => {
            const delta = x * 12;
            return y.add(new Vector3(delta, 0, delta));
        });

    export const ArtOfPurification = new GainUpgrade()
        ...
        .setPriceFormula((amount) => new Price().setCost("Funds", new OnoeNum(1e27).mul(new OnoeNum(4).pow(amount))))
        .setMul(x => new Price().setCost("Purifier Clicks", new OnoeNum(3.4).pow(x)));
    ...
    export const DarkerMatter = new GainUpgrade()
        ...
        .setPriceFormula((amount) => new Price().setCost("Power", new OnoeNum(1e15).mul(new OnoeNum(4).pow(amount))))
        .setMul(x => new Price().setCost("Dark Matter", new OnoeNum(3.2).pow(x)));
    ...
    export const SubsonicTreads = new WalkSpeedUpgrade()
        ...
        .setPriceFormula((amount) => new Price().setCost("Bitcoin", OnoeNum.fromSerika(1, amount * 2 + 4)))
    ...
    export const EfficientLearning = new GainUpgrade()
        ...
        .setPriceFormula((amount) => new Price().setCost("Skill", new OnoeNum(4).mul(new OnoeNum(4).pow(amount))))
        .setMul(x => new Price().setCost("Skill", new OnoeNum(1.05).pow(x)));
