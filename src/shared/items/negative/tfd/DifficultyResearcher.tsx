...
function DifficultyResearcherGui({
    ...
    const [inventory, setInventory] = useState<Map<string, number>>(() => {
        ...
        const initial = Packets.inventory.get();
    ...
    const [researchingState, setResearchingState] = useState<Map<string, number>>(() => {
        const clone = new Map<string, number>();
        const initial = Packets.researching.get();
        if (initial !== undefined) {
            for (const [key, value] of initial) {
                clone.set(key, value);
            }
    ...
    useEffect(() => {
        ...
        if (label !== undefined) {
            label.Text = `x${string.format("%.2f", researchMultiplier)}`;
        }
    }, [researchMultiplier]);
    ...
    const description = useMemo(() => {
        ...
        const multiplierText = string.format("x%.2f", researchMultiplier);
                ...
                <frame BackgroundTransparency={1} Size={new UDim2(1, 0, 1, 0)}>
                    ...
                    <frame BackgroundTransparency={1} LayoutOrder={0} Size={new UDim2(1, 0, 0, 44)}>
                        ...
                        <textbutton
                            ...
                            Event={{
                                Activated: () => setActivePage("difficulties"),
                            }}
                        />
                        <textbutton
                            LayoutOrder={1}
                            BackgroundColor3={
                                activePage === "research" ? Color3.fromRGB(80, 80, 140) : Color3.fromRGB(45, 45, 70)
                            }
                            BackgroundTransparency={0.1}
                            BorderSizePixel={0}
                            FontFace={RobotoMonoBold}
                            ...
                            AutoButtonColor={false}
                            Event={{
                                Activated: () => setActivePage("research"),
                            }}
                        />
                    </frame>
                    ...
                    {activePage === "research" ? (
                        <Fragment>
                            ...
                            <textlabel
                                ...
                                Text={`Current Multiplier: x${string.format("%.2f", researchMultiplier)}`}
                            ...
                            {availableEntries.isEmpty() && (
                                <textlabel
                                    ...
                                    FontFace={RobotoMono}
                                    Size={new UDim2(1, 0, 0, 28)}
                                    Text="No items ready for research."
                                    TextColor3={Color3.fromRGB(200, 200, 200)}
                                    TextScaled={true}
                                />
                            )}
                            {availableEntries.map(({ item, amount }) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <textbutton
                                            ...
                                            TextScaled={true}
                                            Event={{
                                                Activated: () => handleAbsorb(item.id, 1),
                                            }}
                                        />
                                        <textbutton
                                            ...
                                            TextScaled={true}
                                            Event={{
                                                Activated: () => handleAbsorb(item.id, amount),
                                            }}
                                        />
                                    </imagelabel>
                                );
                            ...
                            {researchEntries.map(({ item, amount }) => {
                                const color =
                                    item.difficulty.color?.Lerp(Color3.fromRGB(0, 0, 0), 0.4) ??
                                    Color3.fromRGB(50, 40, 90);
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <textbutton
                                            ...
                                            TextScaled={true}
                                            Event={{
                                                Activated: () => handleRelease(item.id, 1),
                                            }}
                                        />
                                        <textbutton
                                            ...
                                            TextScaled={true}
                                            Event={{
                                                Activated: () => handleRelease(item.id, amount),
                                            }}
                                        />
                                    </imagelabel>
                                );
