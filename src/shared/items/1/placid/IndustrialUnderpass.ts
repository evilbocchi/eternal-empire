...
export = new Item(script.Name)
    ...
    .setDescription(
        "Sequel to the Industrial Overpass, except more placid. Droplets passing through the underpass feel more relaxed, gaining %mul% boosts passing through each laser.",
    )
