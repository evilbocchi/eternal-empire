...
export = new Item(script.Name)
    ...
    .setDescription("Your droplet count is reaching extreme limits, and you don't want to craft another Limit Breaker. Produces %val% droplets when %quota% of those values are processed through the attached furnace.")
