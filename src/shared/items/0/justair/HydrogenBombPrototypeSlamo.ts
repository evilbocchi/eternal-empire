...
export = new Item(script.Name)
    ...
    .setDescription("Slamo was sick of clicking and decided, 'I'm just going to make a nuclear fission hydrogen reactor inside myself so it can click for me!' And miraculously, it worked. Clicks at %cps%.")
