...
class InteractableObject implements Keyed {
    static readonly OldBooks1 = new InteractableObject().dialogueUponInteract(
    ...
    static readonly OldBooks2 = new InteractableObject().dialogueUponInteract(
        new Dialogue(EMPTY_NPC, "You take a book from the shelf.")
    ...
    static readonly OldBooks3 = new InteractableObject().dialogueUponInteract(
        new Dialogue(EMPTY_NPC, "You take a book from the shelf.")
    ...
    static readonly OldBooks4 = new InteractableObject().dialogueUponInteract(
        new Dialogue(EMPTY_NPC, "You take a book from the shelf.")
    ...
    static readonly OldBooks5 = new InteractableObject().dialogueUponInteract(
        new Dialogue(EMPTY_NPC, "You take a book from the shelf.")
    ...
    static readonly SuspiciousWall = new InteractableObject().dialogueUponInteract(
        new Dialogue(EMPTY_NPC, "A weird looking emblem-resembling object. You have no idea how to use this.").root,
    );

    static readonly SlamoBook = new InteractableObject().dialogueUponInteract(
    ...
    readonly interacted = new Signal<(utils: Server, player: Player) => void>();
    key!: string;
    dialogue?: Dialogue;
    ...
    onInteract(callback: (utils: Server, player: Player, object: this) => void) {
